// ============================================================
// NEON ARENA - 武器レジストリ（50種類以上の武器を一元管理）
// 全武器の定義（ダメージ、連射速度、弾速、拡散など）を
// 正規化して登録・検索・UI表示（星評価・統計行）を提供
// ============================================================

class WeaponRegistry {
  /* 武器定義リストとマップを初期化し、全武器を定義 */
  constructor() {
    this._list = []; // 武器IDのリスト
  ...
  _calcStars(wp) {
    ...
    stars.reload = this._star(
      1 / (wp.reloadTime || 3),
      [0.2, 0.35, 0.5, 0.7, 1.0],
    );
  ...
  /**
   * 1-5の星評価を計算（武器性能のビジュアル表示用）
   * @param {number} val - 実際の値
   * @param {number[]} thresholds - 星の閾値
   * @returns {number} 1-5の星評価
   */
  ...
  _initDetails() {
    const d = this._map;
    // Pistol (6)
    d.pistol.displayNameJa = "ハンドガン";
    d.pistol.categoryJa = "ピストル";
    ...
    d.heavy_pistol.displayNameJa = "ヘビーピストル";
    d.heavy_pistol.categoryJa = "ピストル";
    d.heavy_pistol.descriptionEn =
      "High-caliber sidearm. Devastating but slow.";
    d.heavy_pistol.strengths = ["高火力", "ヘッドショット倍率が高い"];
    d.heavy_pistol.weaknesses = [
      "連射が遅い",
      "マガジンが小さい",
      "反動が大きい",
    ];
    d.heavy_pistol.recommendedPassives = [
      "heavyHands",
      "steadyAim",
      "extraMagazine",
    ];
    ...
    d.machine_pistol.displayNameJa = "マシンピストル";
    d.machine_pistol.categoryJa = "ピストル";
    d.machine_pistol.descriptionEn =
      "Full-auto sidearm. High fire rate, low damage.";
    d.machine_pistol.strengths = ["連射速度が高い", "機動戦に強い"];
    d.machine_pistol.weaknesses = ["弾の消費が激しい", "命中精度が低い"];
    d.machine_pistol.recommendedPassives = [
      "rapidFire",
      "extraMagazine",
      "luckyShot",
    ];
    ...
    d.revolver.displayNameJa = "リボルバー";
    d.revolver.categoryJa = "ピストル";
    d.revolver.descriptionEn =
      "Six-shooter revolver. Slow but lethal headshots.";
    ...
    d.burst_pistol.displayNameJa = "バーストピストル";
    d.burst_pistol.categoryJa = "ピストル";
    ...
    d.burst_pistol.recommendedPassives = [
      "steadyAim",
      "sharpshooter",
      "rapidFire",
    ];
    ...
    d.auto_pistol.displayNameJa = "オートピストル";
    d.auto_pistol.categoryJa = "ピストル";
    ...
    // SMG (5)
    d.smg.displayNameJa = "SMG";
    d.smg.categoryJa = "サブマシンガン";
    ...
    d.compact_smg.displayNameJa = "コンパクトSMG";
    d.compact_smg.categoryJa = "サブマシンガン";
    d.compact_smg.descriptionEn =
      "Lightweight SMG. Fast reload, great mobility.";
    ...
    d.vector.displayNameJa = "ベクター";
    d.vector.categoryJa = "サブマシンガン";
    ...
    d.p90.displayNameJa = "P90";
    d.p90.categoryJa = "サブマシンガン";
    ...
    // Assault Rifle (5)
    d.assault.displayNameJa = "アサルトライフル";
    d.assault.categoryJa = "アサルトライフル";
    ...
    d.ak_rifle.displayNameJa = "AKライフル";
    d.ak_rifle.categoryJa = "アサルトライフル";
    ...
    d.carbine.displayNameJa = "カービン";
    d.carbine.categoryJa = "アサルトライフル";
    ...
    d.bullpup.displayNameJa = "ブルパップライフル";
    d.bullpup.categoryJa = "アサルトライフル";
    ...
    d.battlerifle.displayNameJa = "バトルライフル";
    d.battlerifle.categoryJa = "アサルトライフル";
    d.battlerifle.descriptionEn =
      "Large-caliber battle rifle. Powerful and precise.";
    d.battlerifle.strengths = ["大口径の高火力", "高い命中精度"];
    d.battlerifle.weaknesses = ["連射が遅い", "反動が強い"];
    d.battlerifle.recommendedPassives = [
      "heavyHands",
      "steadyAim",
      "hollowPoint",
    ];
    ...
    // Marksman Rifle (4)
    d.marksman.displayNameJa = "マークスマンライフル";
    d.marksman.categoryJa = "マークスマンライフル";
    ...
    d.dmr.displayNameJa = "DMR";
    d.dmr.categoryJa = "マークスマンライフル";
    ...
    d.semi_auto_rifle.displayNameJa = "セミオートライフル";
    d.semi_auto_rifle.categoryJa = "マークスマンライフル";
    d.semi_auto_rifle.descriptionEn =
      "Semi-auto marksman rifle. Quick follow-up shots.";
    d.semi_auto_rifle.strengths = ["素早い連射が可能", "バランスが良い"];
    d.semi_auto_rifle.weaknesses = ["一発の火力は控えめ"];
    d.semi_auto_rifle.recommendedPassives = [
      "rapidFire",
      "sharpshooter",
      "steadyAim",
    ];
    ...
    d.scout_rifle.displayNameJa = "スカウトライフル";
    d.scout_rifle.categoryJa = "マークスマンライフル";
    ...
    // Sniper Rifle (4)
    d.sniper.displayNameJa = "スナイパーライフル";
    d.sniper.categoryJa = "スナイパーライフル";
    ...
    d.heavy_sniper.displayNameJa = "ヘビースナイパー";
    d.heavy_sniper.categoryJa = "スナイパーライフル";
    ...
    d.heavy_sniper.recommendedPassives = [
      "heavyHands",
      "extraMagazine",
      "deadeye",
    ];
    ...
    d.rail_sniper.displayNameJa = "レールスナイパー";
    d.rail_sniper.categoryJa = "スナイパーライフル";
    d.rail_sniper.descriptionEn =
      "Railgun sniper. Instant velocity penetration.";
    d.rail_sniper.strengths = ["瞬間速度", "貫通力が高い"];
    d.rail_sniper.weaknesses = ["取り回しが重い", "接近戦に弱い"];
    d.rail_sniper.recommendedPassives = [
      "armorPiercing",
      "piercingRounds",
      "heavyBarrel",
    ];
    ...
    d.anti_material_rifle.displayNameJa = "対物ライフル";
    d.anti_material_rifle.categoryJa = "スナイパーライフル";
    d.anti_material_rifle.descriptionEn =
      "Explosive ammo sniper. Anti-vehicle grade.";
    d.anti_material_rifle.strengths = ["爆発性弾薬", "範囲攻撃可能"];
    d.anti_material_rifle.weaknesses = ["装弾数2発", "リロードが極めて遅い"];
    d.anti_material_rifle.recommendedPassives = [
      "explosiveAmmo",
      "heavyHands",
      "efficient",
    ];
    ...
    // Shotgun (5)
    d.shotgun.displayNameJa = "ショットガン";
    d.shotgun.categoryJa = "ショットガン";
    ...
    d.auto_shotgun.displayNameJa = "オートショットガン";
    d.auto_shotgun.categoryJa = "ショットガン";
    ...
    d.auto_shotgun.recommendedPassives = [
      "triggerHappy",
      "extraMagazine",
      "giantBullets",
    ];
    ...
    d.double_barrel.displayNameJa = "ダブルバレル";
    d.double_barrel.categoryJa = "ショットガン";
    ...
    d.double_barrel.recommendedPassives = [
      "heavyHands",
      "quickReload",
      "giantBullets",
    ];
    ...
    d.combat_shotgun.displayNameJa = "コンバットショットガン";
    d.combat_shotgun.categoryJa = "ショットガン";
    ...
    d.combat_shotgun.recommendedPassives = [
      "heavyHands",
      "sharpshooter",
      "quickReload",
    ];
    ...
    d.slug_shotgun.displayNameJa = "スラグショットガン";
    d.slug_shotgun.categoryJa = "ショットガン";
    ...
    d.slug_shotgun.recommendedPassives = [
      "sharpshooter",
      "deadeye",
      "heavyHands",
    ];
    ...
    // LMG (4)
    d.lmg.displayNameJa = "軽機関銃";
    d.lmg.categoryJa = "LMG";
    ...
    d.heavy_lmg.displayNameJa = "重機関銃";
    d.heavy_lmg.categoryJa = "LMG";
    d.heavy_lmg.descriptionEn =
      "Heavy MG. High damage per round, anti-material.";
    d.heavy_lmg.strengths = ["100発マガジン", "高火力", "貫通力"];
    d.heavy_lmg.weaknesses = ["機動性が極めて低い", "リロードが非常に遅い"];
    d.heavy_lmg.recommendedPassives = [
      "heavyHands",
      "armorPiercing",
      "efficient",
    ];
    ...
    d.mobile_lmg.displayNameJa = "モバイルLMG";
    d.mobile_lmg.categoryJa = "LMG";
    ...
    d.minigun.displayNameJa = "ミニガン";
    d.minigun.categoryJa = "LMG";
    ...
    // Beam (4)
    d.plasma_rifle.displayNameJa = "プラズマライフル";
    d.plasma_rifle.categoryJa = "ビーム";
    ...
    d.plasma_rifle.recommendedPassives = [
      "beamOvercharge",
      "coolingSystem",
      "wideBeam",
    ];
    ...
    d.laser_rifle.displayNameJa = "レーザーライフル";
    d.laser_rifle.categoryJa = "ビーム";
    d.laser_rifle.descriptionEn =
      "Precision laser. High-damage semi-auto beam.";
    d.laser_rifle.strengths = ["精密照射", "高ヘッドショット倍率"];
    d.laser_rifle.weaknesses = ["連射が遅い", "オーバーヒートしやすい"];
    d.laser_rifle.recommendedPassives = [
      "beamOvercharge",
      "longBeam",
      "deadeye",
    ];
    ...
    d.beam_cannon.displayNameJa = "ビームキャノン";
    d.beam_cannon.categoryJa = "ビーム";
    ...
    d.beam_cannon.recommendedPassives = [
      "wideBeam",
      "beamOvercharge",
      "longBeam",
    ];
    ...
    d.continuous_beam.displayNameJa = "コンティニアスビーム";
    d.continuous_beam.categoryJa = "ビーム";
    d.continuous_beam.descriptionEn =
      "Sustained beam. Damage ramps up over time.";
    d.continuous_beam.strengths = ["持続照射で火力上昇", "制圧力が高い"];
    d.continuous_beam.weaknesses = ["オーバーヒート管理が重要", "機動性が低い"];
    d.continuous_beam.recommendedPassives = [
      "coolingSystem",
      "beamOvercharge",
      "wideBeam",
    ];
    ...
    // Energy (4)
    d.plasma_smg.displayNameJa = "プラズマSMG";
    d.plasma_smg.categoryJa = "エネルギー";
    ...
    d.ion_rifle.displayNameJa = "イオンライフル";
    d.ion_rifle.categoryJa = "エネルギー";
    ...
    d.ion_rifle.recommendedPassives = [
      "coolingSystem",
      "heavyBarrel",
      "heavyHands",
    ];
    ...
    d.arc_rifle.displayNameJa = "アークライフル";
    d.arc_rifle.categoryJa = "エネルギー";
    d.arc_rifle.descriptionEn = "Arc lightning. Chains to nearby enemies.";
    d.arc_rifle.strengths = [
      "電撃チェーン",
      "複数敵にダメージ",
      "リロード不要",
    ];
    d.arc_rifle.weaknesses = ["直撃火力は控えめ"];
    d.arc_rifle.recommendedPassives = [
      "chainLightning",
      "coolingSystem",
      "luckyShot",
    ];
    ...
    d.pulse_carbine.displayNameJa = "パルスカービン";
    d.pulse_carbine.categoryJa = "エネルギー";
    ...
    d.pulse_carbine.recommendedPassives = [
      "coolingSystem",
      "sharpshooter",
      "steadyAim",
    ];
    ...
    // Explosive (5)
    d.rpg.displayNameJa = "ロケットランチャー";
    d.rpg.categoryJa = "爆発物";
    ...
    d.grenade_launcher.displayNameJa = "グレネードランチャー";
    d.grenade_launcher.categoryJa = "爆発物";
    d.grenade_launcher.descriptionEn = "Lobbed grenades. Bouncing area denial.";
    d.grenade_launcher.strengths = [
      "曲射可能",
      "跳ねるグレネード",
      "広い爆発範囲",
    ];
    d.grenade_launcher.weaknesses = ["直撃が難しい", "弾道予測が必要"];
    d.grenade_launcher.recommendedPassives = [
      "efficient",
      "explosiveAmmo",
      "heavyHands",
    ];
    ...
    d.quad_rocket.displayNameJa = "クアッドロケット";
    d.quad_rocket.categoryJa = "爆発物";
    d.quad_rocket.descriptionEn =
      "4-tube rocket launcher. Rapid sequential fire.";
    d.quad_rocket.strengths = ["連続発射", "圧倒的な制圧力"];
    d.quad_rocket.weaknesses = ["リロードが長い", "弾消費が激しい"];
    d.quad_rocket.recommendedPassives = [
      "triggerHappy",
      "efficient",
      "extraMagazine",
    ];
    ...
    d.sticky_launcher.displayNameJa = "スティッキーランチャー";
    d.sticky_launcher.categoryJa = "爆発物";
    ...
    d.sticky_launcher.recommendedPassives = [
      "efficient",
      "explosiveAmmo",
      "extraMagazine",
    ];
    ...
    d.cluster_launcher.displayNameJa = "クラスターランチャー";
    d.cluster_launcher.categoryJa = "爆発物";
    d.cluster_launcher.descriptionEn =
      "Cluster bombs. Split into sub-munitions.";
    d.cluster_launcher.strengths = ["子弾に分裂", "広範囲カバー"];
    d.cluster_launcher.weaknesses = ["単体火力は低い", "リロードが長い"];
    d.cluster_launcher.recommendedPassives = [
      "clusterRound",
      "explosiveAmmo",
      "efficient",
    ];
    ...
    if (d.gravity_gun) {
      d.gravity_gun.displayNameJa = "グラビティガン";
      d.gravity_gun.categoryJa = "実験兵器";
    ...
    if (d.black_hole_launcher) {
      d.black_hole_launcher.displayNameJa = "ブラックホールランチャー";
      d.black_hole_launcher.categoryJa = "実験兵器";
      d.black_hole_launcher.descriptionEn =
        "Creates gravity wells. Pulls enemies in.";
      d.black_hole_launcher.strengths = [
        "重力場で敵を集める",
        "範囲コントロール",
      ];
      d.black_hole_launcher.weaknesses = [
        "リロードが極めて長い",
        "直接火力が低い",
      ];
      d.black_hole_launcher.recommendedPassives = [
        "efficient",
        "heavyHands",
        "extraMagazine",
      ];
      d.black_hole_launcher.recommendedFor = [
        "ゾーンコントロール",
        "サポート役",
      ];
    }
    ...
    if (d.time_distorter) {
      d.time_distorter.displayNameJa = "タイムディストーター";
      d.time_distorter.categoryJa = "実験兵器";
      d.time_distorter.descriptionEn =
        "Time-warp field. Slows enemies, speeds allies.";
      d.time_distorter.strengths = ["時間操作", "敵減速・味方加速"];
      d.time_distorter.weaknesses = ["直接火力が低い"];
      d.time_distorter.recommendedPassives = [
        "runner",
        "sprinter",
        "efficient",
      ];
    ...
    if (d.boomerang_blade) {
      d.boomerang_blade.displayNameJa = "ブーメランブレード";
      d.boomerang_blade.categoryJa = "実験兵器";
      d.boomerang_blade.descriptionEn =
        "Throwable boomerang blade. Unique trajectory.";
      d.boomerang_blade.strengths = ["独特な軌道", "予測困難"];
      d.boomerang_blade.weaknesses = "扱いが難しい,射程が限られる".split(",");
      d.boomerang_blade.recommendedPassives = [
        "ricochetExpert",
        "heavyHands",
        "highVelocity",
      ];
    ...
    if (d.mirror_shot) {
      d.mirror_shot.displayNameJa = "ミラーショット";
      d.mirror_shot.categoryJa = "実験兵器";
      d.mirror_shot.descriptionEn =
        "Wall-bouncing bullets. Unpredictable angles.";
      d.mirror_shot.strengths = ["壁跳ね返り", "予測不能な攻撃"];
      d.mirror_shot.weaknesses = ["操作が非常に難しい"];
      d.mirror_shot.recommendedPassives = [
        "ricochetExpert",
        "doubleRicochet",
        "sharpshooter",
      ];
    ...
    // Drone (4)
    if (d.attack_drone) {
      d.attack_drone.displayNameJa = "アタックドローン";
      d.attack_drone.categoryJa = "ドローン";
      d.attack_drone.descriptionEn =
        "Deploys an attack drone. Auto-tracks enemies.";
      d.attack_drone.strengths = ["自動追尾", "設置後の継続攻撃"];
      d.attack_drone.weaknesses = [
        "展開中は他武器が使えない",
        "リロードが長い",
      ];
      d.attack_drone.recommendedPassives = [
        "heavyBarrel",
        "longBeam",
        "luckyShot",
      ];
    ...
    if (d.missile_drone) {
      d.missile_drone.displayNameJa = "ミサイルドローン";
      d.missile_drone.categoryJa = "ドローン";
      d.missile_drone.descriptionEn =
        "Deploys a missile drone. Tracking projectiles.";
      d.missile_drone.strengths = ["追尾ミサイル", "高火力"];
      d.missile_drone.weaknesses = [
        "展開中は他武器が使えない",
        "リロードが長い",
      ];
      d.missile_drone.recommendedPassives = [
        "explosiveAmmo",
        "heavyHands",
        "efficient",
      ];
    ...
    if (d.orbit_drone) {
      d.orbit_drone.displayNameJa = "オービットドローン";
      d.orbit_drone.categoryJa = "ドローン";
      ...
      d.orbit_drone.recommendedPassives = [
        "wideBeam",
        "luckyShot",
        "efficient",
      ];
    ...
    if (d.turret_launcher) {
      d.turret_launcher.displayNameJa = "タレットランチャー";
      d.turret_launcher.categoryJa = "ドローン";
      d.turret_launcher.descriptionEn =
        "Deploys a turret. Auto-targets enemies.";
      d.turret_launcher.strengths = [
        "固定式タレット",
        "自動照準",
        "防御線構築",
      ];
      d.turret_launcher.weaknesses = ["設置場所が重要", "リロードが長い"];
      d.turret_launcher.recommendedPassives = [
        "sharpshooter",
        "rapidFire",
        "extraMagazine",
      ];
  ...
  sortByDamage() {
    return this._list
      ...
      .sort(
        (a, b) =>
          this._map[b].damage * (this._map[b].pellets || 1) -
          this._map[a].damage * (this._map[a].pellets || 1),
      );
  }
  /** 連射速度昇順ソート（火力速い順） */
  sortByFireRate() {
    return this._list
      .slice()
      .sort((a, b) => this._map[a].fireRate - this._map[b].fireRate);
  }
  /** 射程降順ソート */
  sortByRange() {
    return this._list
      .slice()
      .sort((a, b) => this._map[b].range - this._map[a].range);
  }
  ...
  starsToString(n) {
    return (
      "★".repeat(Math.max(1, Math.min(5, n || 1))) +
      "☆".repeat(Math.max(0, 5 - Math.max(1, Math.min(5, n || 1))))
    );
  }
